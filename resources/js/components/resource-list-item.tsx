...
export default function ResourceListItem({ resource }: { resource: resourceItem }) {
    ...
    return (
        <>
            {isVisible && (
                <div key={resource.id} className="rounded-lg border border-border bg-card p-4 transition-colors hover:bg-accent/50 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <Link href={resource.view_url}>
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction className="text-destructive" onClick={() => deleteItem(resource.delete_url, resource.id)}>
                                        Delete
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
